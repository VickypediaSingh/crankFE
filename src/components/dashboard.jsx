...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 min-h-screen bg-[#121212] text-white animate-fadeIn">
      {/* Header Section */}
      <div className="text-center mb-12">
        <h2 className={`text-3xl sm:text-4xl font-bold mb-3 transition-all duration-300 ${
            ...
            >
              <div className="bg-[#1e1e1e] p-6 rounded-xl border border-[#2e2e2e] hover:border-[#93c740] transition-all flex items-center space-x-4 relative overflow-hidden hover:shadow-lg hover:shadow-[#93c740]/10 hover:-translate-y-1">
                ...
                <div className="z-10">
                  ...
                  <p className="text-sm text-gray-400">Upload a new ambassador</p>
                </div>
              </div>
            </Link>
          </div>
...
function StatCard({ title, value, color, icon }) {
  ...
  return (
    <div className={`p-6 rounded-xl border ${colorMap[color].border} ${colorMap[color].bg} transition-all duration-300 hover:-translate-y-1 ${colorMap[color].hover} hover:shadow-lg`}>
      <div className="flex items-center space-x-4">
        <div className={`p-3 rounded-full ${colorMap[color].iconBg} transition-colors duration-300`}>
          <span className="text-xl">{icon}</span>
        </div>
        <div>
